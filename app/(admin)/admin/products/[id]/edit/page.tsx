...
export default function EditProductPage() {
  ...
  const addImage = () => {
    ...
    setForm((p) => ({ ...p, images: [...p.images, { url, publicId: `manual-${Date.now()}` }] }));
    setImageUrl("");
  };
          ...
          <Section title="Category & Attributes">
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.category} onChange={(e) => update("category", e.target.value)} required className="w-full px-4 py-2.5 bg-white border border-border rounded-md text-ivory focus:outline-none focus:ring-2 focus:ring-gold/40 focus:border-gold">
